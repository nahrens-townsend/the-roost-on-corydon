...
export default function MenuLineArt() {
  return (
    <div className={styles.layer} aria-hidden="true">
      ...
      {/* Top-left branch */}
      <div className={`${styles.piece} ${styles.branchTL} ${styles.animNudge}`}>
        <svg
          {...S}
          width="233"
          height="368"
      ...
      {/* Top-right branch (horizontal flip via inner <g>) */}
      <div
        className={`${styles.piece} ${styles.branchTR} ${styles.animNudge}`}
      ...
      >
        <svg
          ...
          strokeWidth="1.5"
        >
          <g transform="scale(-1,1) translate(-155,0)">
            <BranchPaths />
          </g>
        </svg>
      </div>
